...
static constexpr uint8_t CHIP_TO_ARDUINO[29] = {
  /*  0 (unused) */ NC,
  /*  1 A14      */ 23,
  /*  2 A12      */ 25,
  /*  3 A7       */ 27,
...
static constexpr uint8_t ADDR_PINS[15] = {
...
static constexpr uint8_t PIN_CE = CHIP_TO_ARDUINO[CP_CE]; // active low
static constexpr uint8_t PIN_OE = CHIP_TO_ARDUINO[CP_OE]; // active low
static constexpr uint8_t PIN_WE = CHIP_TO_ARDUINO[CP_WE]; // active low
